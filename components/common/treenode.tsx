...
const BinaryTreeNode: React.FC<Props> = ({ node, getColor, highlightedId }) => {
  ...
  {/* Connector lines */}
  <div className="relative flex justify-center mt-2 w-full max-w-[900px]">
    {/* horizontal line connecting children */}
    <div className="absolute top-0 left-[20%] right-[20%] border-t border-gray-400" />
    {/* vertical lines */}
    <div className="absolute top-0 left-[20%] border-l border-gray-400 h-2" />
    <div className="absolute top-0 right-[20%] border-l border-gray-400 h-2" />
  </div>

  {/* Children */}
  <div className="grid grid-cols-2 gap-x-48 mt-4 w-full max-w-[800px]">
    {/* Left */}
