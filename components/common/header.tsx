  ...
  return (
    <header className="flex items-center justify-between w-full max-md:w-screen px-4 py-2 bg-white dark:bg-gray-900 h-[60px] shadow-sm">
      <div className="flex items-center space-x-3">
        ...
        <button onClick={onMenuClick} className="md:hidden p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">
          <HiOutlineMenuAlt2   size={30} className=" text-gray-800 dark:text-gray-200" />
        </button>
      ...
      <div className="flex items-center space-x-4 max-md:space-x-2">
        ...
        <button className="px-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800" title={user?.user_id}>
