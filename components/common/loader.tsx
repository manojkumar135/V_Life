    ...
    <>
      ...
      >
        ...
        <g transform="translate(2,2)">
          ...
          <g transform="translate(13.75,9.25)" className="loader__model">
            ...
            <g strokeLinecap="round" stroke="#D4AF37"> {/* Gold color for sand */}
              <line
                y2="20.75"
                x2="12"
                y1="15.75"
              ...
              <g strokeWidth="0" fill="#D4AF37"> {/* Gold color for sand mounds */}
                <path
            ...
            {/* Glass frame - changed to dark metallic */}
            <rect height="2" width="24.5" fill="#222"></rect>
            <rect
              height="1"
              width="19.5"
              y="0.5"
      ...
      <style jsx>{`
        ...
        .loader__motion-thick {
          ...
          stroke: rgba(255, 215, 0, 0.2); /* Gold tint for motion */
        }
        .loader__motion-medium {
          animation-name: motion-medium;
          stroke: rgba(255, 215, 0, 0.15); /* Gold tint for motion */
        }
        .loader__motion-thin {
          animation-name: motion-thin;
          stroke: rgba(255, 215, 0, 0.1); /* Gold tint for motion */
        }
        .loader__sand-drop {
