        ...
        <div className="rounded-xl p-6 border border-gray-300 bg-gray-100 shadow-sm">
          <form className="space-y-5">
            ...
            <div className="flex items-center">
              <label className="w-48 text-sm font-medium">Group ID :</label>
              <input
                type="text"
                defaultValue="GP000003"
            ...
            {/* Group Name */}
            <div className="flex items-center">
              <label className="w-48 text-sm font-medium">Group Name :</label>
              <input
                type="text"
            ...
            <div className="flex items-start">
              ...
              <div className="grid grid-cols-3 gap-x-6 gap-y-2 text-sm w-[60%]">
