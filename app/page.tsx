...
const MaverickHome = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Every product and plan is backed by science, feasibility, and real results.",
    },
    {
      icon: <FaBolt />,
  ...
  const steps = [
    {
      title: "Join & Discover",
      icon: <FaRocket />,
      desc: "Sign up and explore Maverick's ecosystem — products, plans, and community built for you.",
    },
    {
      title: "Learn & Grow",
      icon: <FaBolt />,
      desc: "Enroll in our exclusive 4-phase Maverick Academy training and build entrepreneurial skills.",
    },
    {
      title: "Earn & Thrive",
      icon: <FaChartLine />,
      desc: "Activate your Quad-Core Plan, share products you believe in, and enjoy residual income.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      initials: "RK",
      text: "Joining Maverick changed my life. The products are genuine, the community is supportive, and the income opportunity is real.",
    },
    {
      name: "Priya Sharma",
      role: "Team Leader",
      initials: "PS",
      text: "Maverick Academy training gave me confidence and clarity. Now I lead a team and help others find the same path to wellness and freedom.",
    },
    {
      name: "Anil Mehta",
      role: "Entrepreneur",
      initials: "AM",
      text: "Every product has a purpose, every plan is realistic. Maverick is not just a business — it's a movement built on real values.",
    },
  ];
  ...
  return (
    <div id="home" className="min-h-screen flex flex-col bg-white font-sans">
      ...
      <div
        ref={navRef}
        className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-5 md:px-8 pt-3 sm:pt-4"
      >
        <motion.nav
      ...
      <section className="relative w-full h-screen min-h-140 overflow-hidden">
          ...
          <div className="w-full max-w-8xl mx-auto px-5 sm:px-8 md:px-12 lg:px-16">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.p
                  variants={fadeUp}
                  className="text-white/70 text-sm sm:text-base md:text-lg leading-relaxed mb-8 sm:mb-10 max-w-md font-light"
                >
                ...
                <motion.div
                  variants={fadeUp}
                  className="flex items-center gap-5 sm:gap-8 mt-8 sm:mt-10"
                >
                  {[
                    ...
                    <div key={i} className="flex flex-col">
                      ...
                      <span className="text-[10px] sm:text-xs text-white/50 font-medium uppercase tracking-wider mt-0.5">
                        {s.label}
                      </span>
                    </div>
                  ))}
                  ...
                  <div className="hidden sm:flex -space-x-2">
                    {["RK", "PS", "AM", "SK"].map((init, i) => (
                      <div
                        key={i}
                        className="w-7 h-7 rounded-full border-2 border-white/60 bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white text-[9px] font-bold"
                      >
                        {init}
                      </div>
                    ))}
        ...
        <button
          onClick={() =>
            setHeroSlide((p) => (p - 1 + heroSlides.length) % heroSlides.length)
          }
          className="absolute left-3 sm:left-5 md:left-7 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/12 border border-white/25 hidden sm:flex items-center justify-center text-white hover:bg-white/25 transition-all backdrop-blur-sm"
        >
          <svg
            width="14"
            height="14"
        ...
        <button
          ...
          className="absolute right-3 sm:right-5 md:right-7 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/12 border border-white/25 hidden sm:flex items-center justify-center text-white hover:bg-white/25 transition-all backdrop-blur-sm"
        >
          <svg
            width="14"
            height="14"
      ...
      <section
        id="products"
        className={`${sectionClass} px-4 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-white`}
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="text-[#16B8E4] text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase mb-2 sm:mb-3"
            >
              Our Products
            </motion.p>
            <motion.h2
            ...
            >
              Explore Our{" "}
              <span className="bg-linear-to-r from-[#0C3978] to-[#16B8E4] bg-clip-text text-transparent">
                Innovative Range
              </span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="text-gray-500 max-w-lg mx-auto text-xs sm:text-sm leading-relaxed"
            >
              Science-backed, quality-driven products. Download any product
              guide below.
            </motion.p>
          </motion.div>
          <motion.div
      ...
      <section className="px-4 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-linear-to-br from-[#0C3978] to-[#0a2d60] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-white/55 mt-3 max-w-xl mx-auto text-xs sm:text-sm"
            >
              Everything you need to grow personally, financially, and
              professionally — all in one ecosystem.
            </motion.p>
          </motion.div>
          <motion.div
            initial="hidden"
          ...
          >
            {features.map((f, idx) => (
              ...
              >
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-linear-to-br from-[#16B8E4] to-[#0C3978] flex items-center justify-center text-white text-lg sm:text-xl mb-4 sm:mb-5 shadow-lg group-hover:scale-110 transition-transform">
                  {f.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-10 lg:gap-14 items-center">
          ...
          >
            <div className="relative w-full max-w-xs sm:max-w-sm mx-auto">
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white">
                ...
                <div>
                  ...
                  <p className="text-base font-extrabold bg-linear-to-r from-[#0C3978] to-[#16B8E4] bg-clip-text text-transparent leading-tight">
                    10,000+
                  </p>
                </div>
              </motion.div>
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0c3978] mb-4 sm:mb-6 leading-tight"
            >
              STORY OF{" "}
              <span className="bg-linear-to-r from-[#0C3978] to-[#16B8E4] bg-clip-text text-transparent">
                WELLNESS
            ...
            <motion.p
              variants={fadeUp}
              className="text-[#778598] mb-3 sm:mb-4 leading-relaxed text-sm"
            >
              The{" "}
              <strong className="text-[#0c3978]">"Story of Wellness"</strong>{" "}
              reflects the journey toward complete well-being — physical,
              mental, emotional, and spiritual — emphasizing balance and harmony
              in all aspects of life.
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="text-[#778598] mb-5 sm:mb-6 leading-relaxed text-sm"
            >
              Wellness begins with an awakening — realizing the need to care for
              mind, body, and soul through purposeful living.
            </motion.p>
            <motion.div
              variants={stagger}
            ...
            >
              {[
                ...
                <motion.span
                  key={i}
                  variants={fadeUp}
                  className="flex items-center gap-1.5 bg-[#0C3978]/8 border border-[#16B8E4]/25 text-[#0c3978] text-[11px] font-semibold px-3 py-1.5 rounded-full"
                >
                  <FaCheckCircle className="text-[#16B8E4] text-[9px]" />
                  {tag}
                </motion.span>
              ))}
            </motion.div>
            <motion.div
              variants={fadeUp}
              className="border-t border-[#cacccd] pt-4 sm:pt-5"
            >
              <p className="text-[#0c3978] font-semibold text-sm">
                Embracing Balance:{" "}
                <span className="text-[#778598] font-normal">
                  Nurture mental clarity, emotional calm, and physical strength
                  while discovering purpose and fulfillment.
                </span>
              </p>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-7">
            ...
            >
              ...
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white text-lg sm:text-xl mb-5 shadow-lg">
                <FaUsers />
              </div>
              <h3 className="text-xl sm:text-2xl font-extrabold text-gray-900 mb-3 sm:mb-4">
                Who We Are
              </h3>
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                we empower individuals with a uniquely blended hybrid
                opportunity that enables them to grow on their own terms.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#16B8E4]/20 border border-[#16B8E4]/30 flex items-center justify-center text-[#16B8E4] text-lg sm:text-xl mb-5">
                <FaRocket />
              </div>
      ...
      <section className="px-4 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-linear-to-br from-gray-50 to-blue-50/30">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={stagger}
            className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-7 relative"
          >
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="relative mb-5 sm:mb-6">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white text-xl sm:text-2xl shadow-lg shadow-[#16B8E4]/20">
                    {step.icon}
                  </div>
                  <span className="absolute -top-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-white border-2 border-[#16B8E4] text-[#0C3978] text-[10px] sm:text-xs font-extrabold flex items-center justify-center shadow-sm">
                    {idx + 1}
                  </span>
                </div>
      ...
      <section className="bg-[#0C3978] py-4 sm:py-5">
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-4 divide-x divide-white/10">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center py-2 px-3 sm:px-5"
            >
              <span className="text-xl sm:text-2xl md:text-3xl font-extrabold text-white">
                <AnimCounter value={s.num} suffix={s.suf} />
              </span>
              <span className="text-[10px] sm:text-[11px] text-white/50 font-semibold tracking-wider uppercase mt-0.5 text-center">
                {s.label}
              </span>
            </div>
          ))}
      ...
      <section className="px-4 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-white relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-gray-500 mt-3 max-w-lg mx-auto text-xs sm:text-sm"
            >
            ...
            {testimonials.map((t, idx) => (
              ...
              >
                <div className="flex items-center gap-3 pt-2 sm:pt-3 mb-4 border-b border-gray-100">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white font-extrabold text-xs sm:text-sm shrink-0">
                    {t.initials}
                  </div>
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-[#16B8E4] font-medium">
                      {t.role}
                    </p>
                  </div>
                </div>
                <div className="absolute top-4 right-5 text-5xl font-serif text-[#0C3978]/6 leading-none select-none pointer-events-none">
                  "
                </div>
                <div className="flex gap-1 text-yellow-400 text-[10px] sm:text-xs mb-3 sm:mb-4">
                  {[...Array(5)].map((_, i) => (
                    <FaStar key={i} />
                  ))}
                </div>
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed italic flex-1 mb-5 sm:mb-6">
                  {t.text}
                </p>
              </motion.div>
            ))}
          ...
          <div className="relative bg-linear-to-br from-[#0C3978] to-[#061e4d] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-12 p-6 sm:p-10 lg:p-14 xl:p-16 items-start lg:items-center">
              <motion.div
                ...
                className="flex-1"
              >
                <p className="text-[#16B8E4] text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase mb-3 sm:mb-4">
                  Maverick's Promise
                </p>
                ...
                <div className="flex flex-col gap-2 mb-6 sm:mb-8">
                  {[
                    ...
                    >
                      <FaCheckCircle className="text-[#16B8E4] shrink-0 text-xs" />
                      {line}
                    </div>
                  ))}
                </div>
      ...
      <section
        id="contact"
        className={`${sectionClass} px-4 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-linear-to-r from-gray-900 to-[#061e4d] text-white relative overflow-hidden`}
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="text-[#16B8E4] text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase mb-3 sm:mb-4"
            >
              Get In Touch
            </motion.p>
            <motion.h2
              variants={fadeUp}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 sm:mb-5 leading-tight"
            >
              Take the Leap with{" "}
              <span className="bg-linear-to-r from-[#16B8E4] to-white bg-clip-text text-transparent">
                Maverick
            ...
            <motion.p
              variants={fadeUp}
              className="text-white/55 text-sm sm:text-base mb-6 sm:mb-8 leading-relaxed"
            >
              Join a movement built on innovation, integrity, and inspiration.
            ...
            >
              <button
                onClick={() => router.push("/auth/register")}
                className="flex items-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 bg-linear-to-r from-[#0C3978] to-[#16B8E4] text-white font-bold text-sm rounded-lg shadow-lg hover:shadow-[#16B8E4]/30 hover:-translate-y-0.5 transition-all"
              >
                Join Now <FaArrowRight />
              </button>
              <button
                onClick={() => router.push("/auth/login")}
                className="flex items-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 border-2 border-white/25 text-white font-semibold text-sm rounded-lg hover:bg-white/8 hover:border-white/50 transition-all"
              >
                Login to Account
              </button>
            </motion.div>
          ...
          >
            <h3 className="text-lg sm:text-xl font-extrabold text-white mb-1.5 sm:mb-2">
              Ready to start?
            </h3>
            <p className="text-white/50 text-xs sm:text-sm mb-5 sm:mb-7 leading-relaxed">
              Sign up for free and explore the Maverick ecosystem. No
              obligations — just opportunities.
            </p>
            <div className="flex flex-col gap-3 sm:gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Explore all products and plans immediately",
                },
                {
                  icon: <FaLeaf />,
                  title: "Start Earning",
                  desc: "Activate your plan and begin your journey",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-3">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-linear-to-br from-[#0C3978] to-[#16B8E4] flex items-center justify-center text-white text-xs sm:text-sm shrink-0 mt-0.5">
                    {item.icon}
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 pb-8 sm:pb-10 border-b border-white/6">
            <div className="sm:col-span-2">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-gray-500 max-w-sm mb-4 sm:mb-6">
                Pioneering a new era of opportunity, community, and growth.
                Empowering every individual to live their best life through
                wellness and smart earning.
              </p>
              <div className="flex gap-2">
                {[
                  ...
                  <a
                    key={i}
                    href={s.href}
                    className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center text-gray-500 hover:text-white hover:bg-linear-to-br hover:from-[#0C3978] hover:to-[#16B8E4] hover:border-transparent transition-all text-xs sm:text-sm"
                  >
                    {s.icon}
                  </a>
                ))}
            ...
            <div>
              <h4 className="text-white font-bold text-[10px] sm:text-xs tracking-[0.15em] uppercase mb-4 sm:mb-5">
                Quick Links
              </h4>
              <ul className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm">
                <li>
                  <a href="#about" className="hover:text-[#16B8E4] transition">
                    About Us
                  </a>
                </li>
                <li>
              ...
              <ul className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm">
                {products.map((p, i) => (
                  <li key={i}>
                    <a
                      href="#products"
                      className="flex items-center gap-1.5 hover:text-[#16B8E4] transition group/fp"
                    >
                      <FaDownload className="text-[8px] text-[#16B8E4] opacity-0 group-hover/fp:opacity-100 transition shrink-0" />
                      {p.name}
                    </a>
                  </li>
                ))}
