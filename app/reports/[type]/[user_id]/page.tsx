...
/* ─────────────────────────────────────────────────────────────────────
   Main page  (admin drill-down: specific user + reward type)
───────────────────────────────────────────────────────────────────── */
export default function AdminUserRewardDetailPage() {
  ...
  }, [debouncedQuery, direction, dateFilter]);
  ...
  const onBack = () => router.push(`/reports/${type}`);
  ...
  return (
    <Layout>
      <div className="max-md:px-4 p-4 w-full max-w-[99%] mx-auto -mt-5">
        ...
        {/* ── Direction filter pills + active date badge ────────────── */}
