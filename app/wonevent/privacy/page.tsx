...
const Privacy = () => (
  <PolicyLayout title="WON EVENTS - Privacy Policy">
    ...
    <ol className="list-decimal pl-4 space-y-2 text-[0.7rem] text-justify leading-relaxed">
      <li>
        <span className="font-semibold">Introduction - </span>
        This Privacy Policy describes how NOWIT SERVICES INDIA PRIVATE LIMITED
        and its affiliates (collectively &quot;NOWIT SERVICES INDIA PRIVATE LIMITED,
        we, our, us&quot;) collect, use, share, protect or otherwise process your
        information / personal data through our website https://wonevents.com
      ...
      <li>
        ...
        any information. If you receive an email, a call from a person/association
        claiming to be NOWIT SERVICES INDIA PRIVATE LIMITED seeking any personal
      ...
      <li>
        ...
        problems; inform you about online and offline offers, products, services,
      ...
      <li>
        <span className="font-semibold">Security Precautions - </span>
      ...
      <li>
        <span className="font-semibold">Data Deletion and Retention - </span>
        ...
        any other services we may refuse or delay deletion of the account. Once
      ...
      <li>
        ...
        in this Privacy Policy. You have an option to withdraw your consent that
        ...
        communication. We may verify such requests before acting on your
