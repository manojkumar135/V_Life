...
export default function RewardsPage() {
                      ...
                      <div className="flex items-center justify-between mt-2 gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {!isSelected ? (
                            ...
                            <SubmitButton
                              className="px-3 py-1.5 bg-gray-300 text-black font-semibold rounded-md cursor-pointer"
                              onClick={() => handleSelect(reward)}
                              disabled={!isActive}
                            >
                              Remove
        ...
        {Object.keys(selected).length > 0 && (
          <>
            ...
            >
              <LiaGiftsSolid
                size={36}
                className="text-[#FFD700] animate-goldShine"
              />
            </div>
  ...
  <div className="bg-white rounded-2xl shadow-lg w-full max-w-md sm:max-w-lg md:max-w-md p-4 sm:p-6 relative">
    ...
    <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 mt-4 sm:mt-6">
      <button
        onClick={() => setShowModal(false)}
        className="w-full sm:w-auto px-4 py-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300 transition-all duration-200 cursor-pointer"
      >
        Cancel
      </button>
      <button
        ...
        className="w-full sm:w-auto px-5 py-2 rounded-md bg-yellow-400 text-black font-semibold hover:bg-yellow-300 transition-all duration-200 cursor-pointer"
      >
        Book Now
      </button>
    </div>
