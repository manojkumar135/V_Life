...
The Authentic way you step into Business, please read the following terms and conditions very carefully as your use of service is subject to your acceptance of and compliance with the following terms and conditions ("Terms").
...
The user hereby consents, expresses, and agrees that he/she has read and fully understands the Privacy Policy of MAVERICK in respect of the Website. The user further consents that the terms and conditions of such Privacy Policy are acceptable to him/her.

&nbsp;

## **Limited User**

The User agrees and undertakes not to reverse engineer, modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information or software obtained from the website. Limited reproduction and copying of the content of the website is permitted provided that MAVERICK name is stated as the source and prior written permission of MAVERICK is sought.

For the removal of doubt, it is clarified that **unlimited or wholesale reproduction, copying of the content for commercial or non-commercial purposes and unwarranted modification of data and information within the content of the Website is not permitted.**

&nbsp;

## **User Conduct and Rules**

You agree and undertake to use the website and the services only to post and upload messages and material that are proper. By way of example, and not as a limitation, you agree and undertake that when using a service, you will not:  
...
k) In the case of return of the goods from whom they promoted the product, user should settle it after thorough check up in line with our REFUND POLICY and later to submit the same to our LLC with prior consent from company to receive the debit of the same.  
l) At the time of promoting the products of MAVERICK, do take the MAVERICK – ID CARD without fail.

&nbsp;

## **User Warranty and Representation**

The user guarantees, warrants, and certifies that you are the owner of the content which you submit or otherwise authorized to use the content and that the content does not infringe upon the property rights, intellectual property rights or other rights of others. You further warrant that to your knowledge, no action, suit, proceeding, or investigation has been instituted or threatened relating to any content, including trademark, trade name service mark, and copyright formerly or currently used by you in connection with the services rendered by MAVERICK. 

&nbsp;

## **Exactness of Products**

While MAVERICK strives to ensure the quality of any products, services, information, or any other materials purchased or obtained by you through the website, **there may be very few instances where these may not meet your expectations.** In such instances, replacement of products or refund of the amount paid will be as per our product return policy.

&nbsp;

## **Intellectual Property Rights**

a) Unless otherwise indicated or anything contained to the contrary or any proprietary material owned by a third party and so expressly mentioned, MAVERICK owns all Intellectual Property Rights to and into the Website, including, without limitation, any and all rights, title and interest in and to copyright, related rights, patents, utility models, trademarks, trade names, service marks, designs, know-how, trade secrets and inventions (whether patentable or not), goodwill, source code, meta tags, databases, text, content, graphics, icons, and hyperlinks. You acknowledge and agree that you shall not use, reproduce, or distribute any content from the website belonging to MAVERICK without obtaining authorization from MAVERICK.
...
However, with regard to the product customization Service (as against other Services like blogs and forums) you expressly agree that by uploading and posting content on to the Website for public viewing and reproduction/use of your content by third party users, **you accept that you grant a non-exclusive license for the use of the same.**

&nbsp;

## **Links to Third Party Sites**

The Website may contain links to other websites ("Linked Sites"). The Linked Sites are not under the control of MAVERICK or the Website and MAVERICK is not responsible for the contents of any Linked Site, including without limitation any link contained in a Linked Site, or any changes or updates to a Linked Site. MAVERICK is not responsible for any form of transmission, whatsoever, received by you from any linked site.

MAVERICK is providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement of the linked sites by MAVERICK or any association with its operators or owners including the legal heirs or assigns thereof.
...
MAVERICK has endeavoured to ensure that all the information on the website is correct, but MAVERICK neither warrants nor makes any representations regarding the quality, accuracy or completeness of any data, information, product or service.

In no event shall MAVERICK be liable for any direct, indirect, punitive, incidental, special, consequential damages or any other damages resulting from:  
...
You agree to indemnify, defend and hold harmless MAVERICK from and against any and all losses, liabilities, claims, damages, costs and expenses (including legal fees and disbursements in connection therewith and interest chargeable thereon) asserted against or incurred by MAVERICK that arise out of, result from, or may be payable by virtue of, any breach or non-performance of any representation, warranty, covenant or agreement made or obligation to be performed by you pursuant to these terms. 
...
Title and risk of loss for all products ordered by you shall pass on to you upon shipment to the shipping carrier. 

&nbsp;

## **Termination**

a) MAVERICK may suspend or terminate your use of the Website or any Service if it believes, in its sole and absolute discretion that you have breached one or more of these Terms, and if company finds that you are engaged and promoting the competitors.  
b) If you or MAVERICK terminates your use of the Website or any Service, MAVERICK may delete any content or other materials relating to your use of the Service and MAVERICK will have no liability to you or any third party for doing so.  
c) You shall be liable to pay for any Service or product that you have already ordered till the time of Termination by either party whatsoever. Further, you shall be entitled to your royalty payments as per the User License Agreement that has or is legally deemed accrued to you. 

&nbsp;

## **Governing Law**

These terms shall be governed by and constructed in accordance with the laws of India without reference to conflict of laws principles and **disputes arising in relation hereto shall be subject to the exclusive jurisdiction of the courts at Ongole, Andhra Pradesh, India.**
...
As per these Terms, users are solely responsible for every material or content uploaded on to the Website. MAVERICK does not review the contents in any way before they appear on the Website. MAVERICK does not verify, endorse, or otherwise vouch for the contents of any user or any content generally posted or uploaded on to the website.
